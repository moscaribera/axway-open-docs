...
| | |
| `apiportal.jar`               | `vordel-core-7.7.0.20200730-*.jar`<br>`vordel-apimanager-7.7.0.20200730-*.jar`<br>`vordel-api-model-7.7.0.20200730-*.jar`<br>`plugins/vordel-common-7.7.0.20200730-*.jar` |
| | |
